...
class WOO_Vou_Vendor_Pro {
	...
	public function woo_vou_product_save_meta ( $post_id ) {
		...
		$this->vouadmin->woo_vou_product_save_data( $post_id, get_post( $post_id ) );
	}	
	...
	public function add_hooks(){
		...
		add_action( 'wcv_save_product_variation', array( $this->vouadmin, 'woo_vou_product_save_variable_meta' ), 20, 2 );
	}	
}